...
const faqs = [
  ...
  { 
    ...
    answer: "در کیا دِو (KiyaDev) شروع قیمت طراحی سایت لندینگ پیج از ۵,۰۰۰,۰۰۰ تومان و سایت‌های شرکتی/فروشگاهی از ۲۰,۰۰۰,۰۰۰ تومان است. برای اپلیکیشن‌های اختصاصی و PWA، قیمت بر اساس فیچرها محاسبه می‌شود اما تلاش ما ارائه نرخ‌های دانشجویی و رقابتی است." 
  },
