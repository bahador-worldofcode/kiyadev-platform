...
const faqs = [
  ...
  { 
    category: "وب و سایت", 
    question: "هزینه طراحی سایت و اپلیکیشن در پکیج‌های شما چقدر است؟", 
    answer: "در کیا دِو (KiyaDev) پکیج‌های پلتفرم اختصاصی (سایت + اپلیکیشن مدیریت) در سه سطح ارائه می‌شود و در حال حاضر شامل ٪۷۰ تخفیف ویژه هستند: پکیج اقتصادی با ٪۷۰ تخفیف ۲۴.۵ میلیون تومان (قیمت اصلی ۸۱.۵ میلیون تومان)، پکیج استاندارد ۳۴.۵ میلیون تومان (قیمت اصلی ۱۱۵ میلیون تومان) و پکیج ویژه ۴۴.۵ میلیون تومان (قیمت اصلی ۱۴۸.۵ میلیون تومان). برای پروژه‌های استارتاپی کاملاً اختصاصی قیمت بر اساس فیچرها به صورت توافقی محاسبه می‌شود." 
  },
  ...
  { category: "اپلیکیشن", question: "آیا پنل مدیریت اپلیکیشن با سایت یکی است؟", answer: "بله، شما یک پنل واحد دارید که با تغییر در آن، هم سایت و اپلیکیشن شما همزمان بروزرسانی می‌شوند." },
