...
const faqs = [
  ...
  { 
    ...
    answer: "در کیا دِو (KiyaDev) پکیج‌های پلتفرم اختصاصی (سایت + اپلیکیشن مدیریت) در سه سطح ارائه می‌شود: پکیج اقتصادی ۸۱.۵ میلیون تومان، پکیج استاندارد ۱۱۵ میلیون تومان و پکیج ویژه ۱۴۸.۵ میلیون تومان. برای پروژه‌های استارتاپی کاملاً اختصاصی قیمت بر اساس فیچرها به صورت توافقی محاسبه می‌شود." 
  },
