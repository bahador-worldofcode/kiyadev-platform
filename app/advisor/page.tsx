...
export default function AdvisorPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-purple-500/30 overflow-x-hidden scroll-smooth font-sans" dir="rtl">
        ...
        <div className="container mx-auto px-4 h-[72px] flex items-center justify-between">
          <div className="flex flex-col">
            <span className="text-xl md:text-2xl font-black tracking-tighter leading-none text-white">
              Kiya<span className="text-purple-500">Dev</span>
            </span>
          ...
          <a
            ...
            className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-xl text-sm font-bold transition-all active:scale-95 shadow-lg shadow-purple-600/20 border border-purple-500/50"
          >
      ...
      <section className="relative pt-32 pb-20 px-4 min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-slate-300 text-xs md:text-sm mb-8 font-medium">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-[1.3] md:leading-[1.2] tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">امپراتوری دیجیتال خود را بسازید</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="wa.me/989924230576" target="_blank" className="bg-white/5 border border-white/10 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl flex gap-4">
              <Globe className="w-8 h-8 text-purple-400 shrink-0" />
              <div>
            ...
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl flex gap-4">
              <Code2 className="w-8 h-8 text-emerald-400 shrink-0" />
              <div>
      ...
      <section className="py-20 relative">
        <div className="container mx-auto max-w-5xl px-4">
          <div className="bg-gradient-to-r from-purple-900/40 to-blue-900/40 border border-purple-500/20 rounded-3xl p-8 md:p-12 text-center md:text-right flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-2/3">
              ...
              <p className="text-slate-300 leading-relaxed font-medium text-justify">
                تیم مهندسی <strong className="text-white">کیا دِو</strong>، پروژه‌ی شما را از خط اول با تکنولوژی‌های لبه دانش (Next.js) کُدنویسی می‌کند. نتیجه‌ی این کار، <strong className="text-purple-300">سرعت لود زیر ۱ ثانیه</strong>، امنیت بانکی و دریافت یک <strong className="text-purple-300">اپلیکیشن موبایل مدیریت سایت</strong> است تا کل کسب‌وکارتان را از داخل گوشی کنترل کنید.
              </p>
            </div>
            <div className="md:w-1/3 flex justify-center">
               <Smartphone className="w-32 h-32 text-purple-400 opacity-80" strokeWidth={1} />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
            {projects.map((project) => (
              <a 
                ...
                className="group flex items-center justify-between p-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-purple-500/50 transition-all active:scale-95"
              >
                ...
                <ExternalLink size={14} className="text-slate-600 group-hover:text-purple-400 shrink-0" />
              </a>
            ))}
          </div>
      ...
      <section id="pricing" className="py-20 bg-[#0a0a0a] border-t border-white/5">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* پکیج ۲ */}
            <div className="bg-purple-900/20 border-2 border-purple-500/50 rounded-3xl p-8 flex flex-col relative transform md:-translate-y-4 shadow-xl shadow-purple-900/20">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-purple-500 text-white px-4 py-1 rounded-full text-xs font-bold whitespace-nowrap">پیشنهاد استاندارد</div>
              <h3 className="text-xl font-bold text-purple-400 mb-2">پکیج استاندارد</h3>
              <div className="flex items-baseline gap-2 mb-6">
                <span className="text-4xl font-black text-white">۲۰</span>
                <span className="text-sm text-purple-300/50 font-bold">میلیون تومان</span>
              </div>
              <ul className="space-y-4 mb-8 flex-1">
                {['تمام امکانات پکیج اقتصادی', 'راه‌اندازی روی سرور پرسرعت', 'سئوی پایه گوگل', 'ورود ۳۰ محصول اولیه', 'دیتابیس ابری سریع'].map((f, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-white"><CheckCircle2 size={18} className="text-purple-400 shrink-0" /> {f}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col hover:border-white/20 transition-all">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                {['تمام امکانات پکیج استاندارد', 'کدهای ساختاریافته سئو', 'ربات اعلام سفارش بله', 'اتصال به پنل پیامکی', 'طراحی فوق اختصاصی'].map((f, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-slate-300"><CheckCircle2 size={18} className="text-blue-400 shrink-0" /> {f}</li>
                ))}
              </ul>
            </div>
          </div>
      ...
      <footer className="py-16 px-4 bg-[#050505] border-t border-white/5 text-center">
        <div className="container mx-auto max-w-2xl">
          ...
          <div className="flex flex-col gap-4 max-w-sm mx-auto">
            <a href="tel:09924230576" className="flex items-center justify-center gap-3 bg-purple-600 text-white px-6 py-4 rounded-xl font-black text-lg hover:bg-purple-700 transition-all active:scale-95 shadow-lg shadow-purple-600/20">
