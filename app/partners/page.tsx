      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-12">
            ...
            <p className="text-slate-400 max-w-2xl leading-8 text-lg">
                کیا دِو (KiyaDev) خالق و پشتیبان اکوسیستمی از سرویس‌های دیجیتال است. در اینجا می‌توانید منتخبی از پروژه‌های عمومی و شاخص توسعه‌یافته توسط تیم ما و شرکای تجاری را مشاهده کنید.
            </p>
        </div>
